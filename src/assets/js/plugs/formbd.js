/*底部每个表单*/ 
 function add_ajaxmessage() {
	...
	function add_two() {
        ...
        var name = document.getElementById("name_two");
        var tel = document.getElementById("tel_two");
		var time = document.getElementById("time_two");
            var url = window.location.href;
        var mobile = "!/^1\d{10}$/";
        ...
        if ($("#tel_two").val() == "" || !/^1\d{10}$/.test($("#tel_two").val())) {
